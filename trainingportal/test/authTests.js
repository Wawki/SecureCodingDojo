    ...
    describe('#processAuthCallback', async () => {
        ...
        it('should create a new user without a team', async () => {
            ...
            var promise = new Promise((resolve,reject)=>{
                auth.processAuthCallback("authTestUser","Auth Test","User","authtestuser@email.local","student",1,"disabled", (e, u) => {
                    resolve(u);
                });
            });
        ...
        it('should retrieve and return an existing user', async () => {
            ...
            var promise = new Promise((resolve,reject)=>{
                auth.processAuthCallback("authTestTeamOwner","Team","Owner","teamowner@email.local","student",1,"disabled",  (e, u) => {
                    resolve(u);
                });
            });
        ...
        it('should reject a profileId if is not allowed', async () => {
            var promise = new Promise((resolve,reject)=>{
                auth.processAuthCallback("userNotMatchingAllowedPattern","A","B","c@email.local","student",1,"disabled",  (e, u) => {
                    resolve(e);
                });
            });
